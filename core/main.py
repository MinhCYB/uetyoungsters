"""Entrypoint FastAPI app của Career Compass core."""
...
from assessment_store import load_question_bank, save_answers, save_assessment
from database import get_db, init_db
from models import Assessment
from shared.question_bank import generate_question_set, get_question
...
def _validate_answer(question: dict, value: Any) -> str | None:
    ...
    if question_type in ("single_choice", "value_item"):
        ...
        if not isinstance(value, dict) or set(value) != set(question.get("options") or []):
