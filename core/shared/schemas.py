"""
Pydantic models dung chung trong core - la "hop dong" API giua 3 service
(crawl-service, profile-service, core). Xem docs/career-compass-notes.md
muc 4, 6.3, 6.4, 6.5, 12 va docs/career-compass-schema-draft.md.

QUAN TRONG: day la file rui ro conflict cao nhat theo notes muc 9.
Moi thay doi phai bao cho nguoi viet client goi API tuong ung (Nguoi 1, Nguoi 2).
